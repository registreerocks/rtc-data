...
impl RtcEnclaveEcalls for ExecSys {
    unsafe fn enclave_create_report(
        ...
        ffi::rtc_exec_enclave_create_report(eid, retval, p_qe3_target, enclave_data, p_report)
    }
}

impl rtc_udh::ResponderSys for ExecSys {
    unsafe fn rtc_session_request(
        ...
        ffi::rtc_exec_session_request(eid, retval, src_enclave_id)
    }
    ...
    unsafe fn rtc_exchange_report(
        ...
        ffi::rtc_exec_exchange_report(eid, retval, src_enclave_id, dh_msg2_ptr)
    }
    ...
    unsafe fn rtc_end_session(
        ...
        ffi::rtc_exec_end_session(eid, retval, src_enclave_id)
    }
}
