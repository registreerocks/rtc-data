...
static sgx_status_t SGX_CDECL rtc_exec_u_thread_set_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_thread_wait_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_thread_set_multiple_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_thread_setwait_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_clock_gettime_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_read_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_pread64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_readv_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_preadv64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_write_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_pwrite64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_writev_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_pwritev64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fcntl_arg0_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fcntl_arg1_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_ioctl_arg0_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_ioctl_arg1_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_close_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_malloc_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_free_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_mmap_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_munmap_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_msync_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_mprotect_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_open_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_open64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fstat_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fstat64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_stat_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_stat64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_lstat_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_lstat64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_lseek_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_lseek64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_ftruncate_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_ftruncate64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_truncate_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_truncate64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fsync_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fdatasync_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fchmod_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_unlink_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_link_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_rename_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_chmod_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_readlink_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_symlink_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_realpath_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_mkdir_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_rmdir_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_opendir_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_readdir64_r_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_closedir_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_dirfd_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_u_fstatat64_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_rtc_session_request_u(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_rtc_exchange_report_u(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_rtc_end_session_u(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_sgx_oc_cpuidex(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_sgx_thread_wait_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_sgx_thread_set_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_sgx_thread_setwait_untrusted_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL rtc_exec_sgx_thread_set_multiple_untrusted_events_ocall(void* pms)
{
...
static const struct {
	size_t nr_ocall;
	void * table[63];
} ocall_table_rtc_exec = {
	63,
	{
		(void*)rtc_exec_u_thread_set_event_ocall,
		(void*)rtc_exec_u_thread_wait_event_ocall,
		(void*)rtc_exec_u_thread_set_multiple_events_ocall,
		(void*)rtc_exec_u_thread_setwait_events_ocall,
		(void*)rtc_exec_u_clock_gettime_ocall,
		(void*)rtc_exec_u_read_ocall,
		(void*)rtc_exec_u_pread64_ocall,
		(void*)rtc_exec_u_readv_ocall,
		(void*)rtc_exec_u_preadv64_ocall,
		(void*)rtc_exec_u_write_ocall,
		(void*)rtc_exec_u_pwrite64_ocall,
		(void*)rtc_exec_u_writev_ocall,
		(void*)rtc_exec_u_pwritev64_ocall,
		(void*)rtc_exec_u_fcntl_arg0_ocall,
		(void*)rtc_exec_u_fcntl_arg1_ocall,
		(void*)rtc_exec_u_ioctl_arg0_ocall,
		(void*)rtc_exec_u_ioctl_arg1_ocall,
		(void*)rtc_exec_u_close_ocall,
		(void*)rtc_exec_u_malloc_ocall,
		(void*)rtc_exec_u_free_ocall,
		(void*)rtc_exec_u_mmap_ocall,
		(void*)rtc_exec_u_munmap_ocall,
		(void*)rtc_exec_u_msync_ocall,
		(void*)rtc_exec_u_mprotect_ocall,
		(void*)rtc_exec_u_open_ocall,
		(void*)rtc_exec_u_open64_ocall,
		(void*)rtc_exec_u_fstat_ocall,
		(void*)rtc_exec_u_fstat64_ocall,
		(void*)rtc_exec_u_stat_ocall,
		(void*)rtc_exec_u_stat64_ocall,
		(void*)rtc_exec_u_lstat_ocall,
		(void*)rtc_exec_u_lstat64_ocall,
		(void*)rtc_exec_u_lseek_ocall,
		(void*)rtc_exec_u_lseek64_ocall,
		(void*)rtc_exec_u_ftruncate_ocall,
		(void*)rtc_exec_u_ftruncate64_ocall,
		(void*)rtc_exec_u_truncate_ocall,
		(void*)rtc_exec_u_truncate64_ocall,
		(void*)rtc_exec_u_fsync_ocall,
		(void*)rtc_exec_u_fdatasync_ocall,
		(void*)rtc_exec_u_fchmod_ocall,
		(void*)rtc_exec_u_unlink_ocall,
		(void*)rtc_exec_u_link_ocall,
		(void*)rtc_exec_u_rename_ocall,
		(void*)rtc_exec_u_chmod_ocall,
		(void*)rtc_exec_u_readlink_ocall,
		(void*)rtc_exec_u_symlink_ocall,
		(void*)rtc_exec_u_realpath_ocall,
		(void*)rtc_exec_u_mkdir_ocall,
		(void*)rtc_exec_u_rmdir_ocall,
		(void*)rtc_exec_u_opendir_ocall,
		(void*)rtc_exec_u_readdir64_r_ocall,
		(void*)rtc_exec_u_closedir_ocall,
		(void*)rtc_exec_u_dirfd_ocall,
		(void*)rtc_exec_u_fstatat64_ocall,
		(void*)rtc_exec_rtc_session_request_u,
		(void*)rtc_exec_rtc_exchange_report_u,
		(void*)rtc_exec_rtc_end_session_u,
		(void*)rtc_exec_sgx_oc_cpuidex,
		(void*)rtc_exec_sgx_thread_wait_untrusted_event_ocall,
		(void*)rtc_exec_sgx_thread_set_untrusted_event_ocall,
		(void*)rtc_exec_sgx_thread_setwait_untrusted_events_ocall,
		(void*)rtc_exec_sgx_thread_set_multiple_untrusted_events_ocall,
	}
};
sgx_status_t rtc_exec_enclave_create_report(sgx_enclave_id_t eid, CreateReportResult* retval, const sgx_target_info_t* p_qe3_target, EnclaveHeldData enclave_data, sgx_report_t* p_report)
{
	sgx_status_t status;
	...
	status = sgx_ecall(eid, 0, &ocall_table_rtc_exec, &ms);
	if (status == SGX_SUCCESS && retval) *retval = ms.ms_retval;
	return status;
}

sgx_status_t rtc_exec_t_global_init_ecall(sgx_enclave_id_t eid, uint64_t id, const uint8_t* path, size_t len)
{
	sgx_status_t status;
	...
	ms.ms_path = path;
	ms.ms_len = len;
	status = sgx_ecall(eid, 1, &ocall_table_rtc_exec, &ms);
	return status;
}

sgx_status_t rtc_exec_t_global_exit_ecall(sgx_enclave_id_t eid)
{
	sgx_status_t status;
	status = sgx_ecall(eid, 2, &ocall_table_rtc_exec, NULL);
	return status;
}

sgx_status_t rtc_exec_session_request(sgx_enclave_id_t eid, SessionRequestResult* retval, sgx_enclave_id_t src_enclave_id)
{
	sgx_status_t status;
	ms_session_request_t ms;
	ms.ms_src_enclave_id = src_enclave_id;
	status = sgx_ecall(eid, 3, &ocall_table_rtc_exec, &ms);
	if (status == SGX_SUCCESS && retval) *retval = ms.ms_retval;
	return status;
}

sgx_status_t rtc_exec_exchange_report(sgx_enclave_id_t eid, ExchangeReportResult* retval, sgx_enclave_id_t src_enclave_id, const sgx_dh_msg2_t* dh_msg2)
{
	sgx_status_t status;
	ms_exchange_report_t ms;
	ms.ms_src_enclave_id = src_enclave_id;
	ms.ms_dh_msg2 = dh_msg2;
	status = sgx_ecall(eid, 4, &ocall_table_rtc_exec, &ms);
	if (status == SGX_SUCCESS && retval) *retval = ms.ms_retval;
	return status;
}

sgx_status_t rtc_exec_end_session(sgx_enclave_id_t eid, sgx_status_t* retval, sgx_enclave_id_t src_enclave_id)
{
	sgx_status_t status;
	ms_end_session_t ms;
	ms.ms_src_enclave_id = src_enclave_id;
	status = sgx_ecall(eid, 5, &ocall_table_rtc_exec, &ms);
	if (status == SGX_SUCCESS && retval) *retval = ms.ms_retval;
	return status;
}
